...
def get_cities(stations):
    """
    Uses a local copy of the Wikipedia page "List of United States cities by population"
    to generate a list of city names, populations, states and latlongs. Then uses this
    information to add the rest of the data to the city objects
    :param stations: A list of station dictionaries generated by get_stations()
    :return: A list of city dictionaries
    """
...
def add_city_info(cities, download=False):
    ...
    :param download: Determines whether the thumbnails will be downloaded or are local
